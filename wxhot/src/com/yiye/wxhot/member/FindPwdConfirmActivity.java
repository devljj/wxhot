...
public class FindPwdConfirmActivity extends Activity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.ensureregisterbtn.setText("确认修改");
    this.ensureregisterbtn.setOnClickListener(new FindPwdConfirmActivity.1(this));
  }
}

/* Location:           I:\re\wuxihot\classes_dex2jar.jar
 * Qualified Name:     com.yiye.wxhot.member.FindPwdConfirmActivity
