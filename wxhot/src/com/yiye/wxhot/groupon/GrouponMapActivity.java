...
public class GrouponMapActivity extends Activity
{
  private AMap aMap;
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.searchkeyword.setOnFocusChangeListener(new View.OnFocusChangeListener()
    {
      public void onFocusChange(View paramAnonymousView, boolean paramAnonymousBoolean)
      {
        ...
        {
          Intent localIntent = new Intent(GrouponMapActivity.this, SearchActivity.class);
          localIntent.putExtra("activity", "groupon");
          GrouponMapActivity.this.startActivity(localIntent);
          GrouponMapActivity.this.overridePendingTransition(2130968587, 2130968586);
        }
      }
    });
    ...
    implements BDLocationListener
  {
    ...
    public void onReceiveLocation(BDLocation paramBDLocation)
    {
      ...
      GrouponMapActivity.this.aMap.animateCamera(localCameraUpdate);
    }
  }
}

/* Location:           I:\re\wuxihot\classes_dex2jar.jar
 * Qualified Name:     com.yiye.wxhot.groupon.GrouponMapActivity
